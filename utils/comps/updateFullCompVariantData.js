...
export async function updateFullCompVariantData(artikul) {
  ...
  const { yumi, air, sharte, best, aero, balun, svyato, idea, chudo } =
    await getArtDataCompVariant(artikul);
  ...
  if (compStamp) {
    await updateCompVariantStamp(artikul, {
      yumi,
      air,
      sharte,
      best,
    ...
    await createCompVariantStamp(artikul, {
      yumi,
      air,
      sharte,
      best,
...
async function createCompVariantStamp(
  artikul,
  { yumi, air, sharte, best, aero, balun, svyato, idea, chudo }
) {
...
async function updateCompVariantStamp(
  artikul,
  { yumi, air, sharte, best, aero, balun, svyato, idea, chudo }
) {
