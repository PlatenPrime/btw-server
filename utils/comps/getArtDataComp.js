...
export async function getArtDataComp(artikul) {
  ...
  const yumiAction = comp?.competitorsLinks?.yumiLink
    ? getArtDataYumi(comp?.competitorsLinks?.yumiLink)
    : Promise.resolve(null);
  const sharteAction = comp?.competitorsLinks?.sharteLink
    ? getArtDataSharte(comp?.competitorsLinks?.sharteLink)
    : Promise.resolve(null);
  const airAction = comp?.competitorsLinks?.airLink
    ? getArtDataAir(comp?.competitorsLinks?.airLink)
    : Promise.resolve(null);
  const bestAction = comp?.competitorsLinks?.bestLink
    ? getArtDataBest(comp?.competitorsLinks?.bestLink)
    : Promise.resolve(null);

  const aeroAction = comp?.competitorsLinks?.aeroLink
    ? getArtDataAero(comp?.competitorsLinks?.aeroLink)
    : Promise.resolve(null);
  const balunAction = comp?.competitorsLinks?.balunLink
    ? getArtDataBalun(comp?.competitorsLinks?.balunLink)
    : Promise.resolve(null);
  const svyatoAction = comp?.competitorsLinks?.svyatoLink
    ? getArtDataSvyato(comp?.competitorsLinks?.svyatoLink)
    : Promise.resolve(null);
  const ideaAction = comp?.competitorsLinks?.ideaLink
    ? getArtDataIdea(comp?.competitorsLinks?.ideaLink)
    : Promise.resolve(null);
  ...
  let btrade, yumi, air, sharte, best, aero, balun, svyato, idea, chudo;
